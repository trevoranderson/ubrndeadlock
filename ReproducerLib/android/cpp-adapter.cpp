...
// Automated testing checks Java_com_ubrnbugreproducer_UbrnBugReproducerModule and ubrnbugreproducer
...
// Installer coming from UbrnBugReproducerModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ubrnbugreproducer_UbrnBugReproducerModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return ubrnbugreproducer::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_ubrnbugreproducer_UbrnBugReproducerModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return ubrnbugreproducer::cleanupRustCrate(*runtime);
}